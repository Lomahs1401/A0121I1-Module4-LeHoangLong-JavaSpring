    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <form:checkbox path="filter" name="filter" value="${email.filter}"/>Enable spams filter
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <form:textarea path="signature" name="signature" rows="15" cols="50" value="${email.signature}"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
